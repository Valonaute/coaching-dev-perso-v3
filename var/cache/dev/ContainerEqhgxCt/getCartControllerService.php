...
class getCartControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.nGeJP64'] ?? $container->load('get_ServiceLocator_NGeJP64Service'))->withContext('App\\Controller\\CartController', $container));
