...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    'ch_cookie_consent.title' => 'Cookies op onze website.',
    'ch_cookie_consent.intro' => '',
    'ch_cookie_consent.read_more' => 'meer uitleg hierover',
    'ch_cookie_consent.analytics.title' => 'Wilt u analytische cookies?',
    'ch_cookie_consent.analytics.description' => 'Hiermee kunnen wij statistieken verzamelen over de websitebezoek.',
    'ch_cookie_consent.tracking.title' => 'Wilt u tracking cookies?',
    'ch_cookie_consent.tracking.description' => 'Hiermee kunnen wij de gebruikerservaring verbeteren door het surfgedrag te observeren.',
    'ch_cookie_consent.marketing.title' => 'Wilt u gepersonaliseerde advertenties?',
    'ch_cookie_consent.marketing.description' => 'Hiermee kunnen advertentienetwerken uw internetgedrag volgen en ontvangt u gepersonaliseerde advertenties afgestemd op uw internetgedrag',
    'ch_cookie_consent.social_media.title' => 'Wilt u social media cookies?',
    'ch_cookie_consent.social_media.description' => 'Hiermee kunnen socialmedianetwerken cookies plaatsen waarmee u en uw internetgedrag gevolgd kunnen worden.',
    'ch_cookie_consent.no' => 'Nee',
    'ch_cookie_consent.yes' => 'Ja',
    'ch_cookie_consent.save' => 'Opslaan',
    'ch_cookie_consent.use_only_functional_cookies' => 'Gebruik alleen noodzakelijke cookies',
    'ch_cookie_consent.use_all_cookies' => 'Sta alle cookies toe',
    'ch_cookie_consent.show_details' => 'Toon details',
    'ch_cookie_consent.hide_details' => 'Verberg details',
  ),
));
