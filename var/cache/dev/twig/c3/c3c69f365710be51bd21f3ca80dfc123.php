...
<html lang=\"fr\">
    ...
    <body>
        <header>
            <a href=\"{{ path ('home')}}\"><img src=\"{{ asset ('assets/img/logo-line.png') }}\" alt=\"logo\" title=\"logo\" class=\"logo-nav\"></a>
            <nav class=\"nav-desktop\">
        ...
        <footer>
            ...
            <div id=\"mySidenavFooter\" class=\"sidenavFooter\">
                ...
                <ul>
                    ...
                    <li><a href=\"{{ path ('mapsite') }}\">Plan du site</a></li>
                    <li><a href=\"{{ path ('contact') }}\">Contact</a></li>
                    <li><a href=\"{{ path ('valonauteinc') }}\" target =\"_blank\">EasyWebFactory Inc.</a></li>
                    <li><a href=\"{{ path ('careers') }}\">On Recrute </a></li>
                    <li>Suivez-nous : </li>
                    <li> <a href=\"https://instagram.com/coaching.devperso\" target =\"_blank\">Instagram</a> </li>
                    <li> <a href=\"https://Facebook.com/valonaute\" target =\"_blank\">Facebook</a> </li>
                    <li> <a href=\"https://www.youtube.com/channel/UC5KXcAr204aLa6F2-4hapGw\" target =\"_blank\">Youtube</a> </li>
