...
class __TwigTemplate_beb34d0260f316d36c5d40d533ebcda7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Mot de passe oublié email envoyé";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <p class=\"my-5\">
        Si un compte avec votre email existe, un email contenant le lien a été envoyé. Vous pouvez l'utiliser pour changer votre mot de passe.
        Ce lien va expirer dans ";
        // line 8
    ...
    <p class=\"my-5\">Si vous ne recevez pas d'email veuillez vérifier votre dossier \"spams\" ou <a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        echo "\">essayer encore </a></p>
";
...
{% block title %}Mot de passe oublié email envoyé{% endblock %}

{% block content %}
    <p class=\"my-5\">
        Si un compte avec votre email existe, un email contenant le lien a été envoyé. Vous pouvez l'utiliser pour changer votre mot de passe.
        Ce lien va expirer dans {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.
    </p>
    <p class=\"my-5\">Si vous ne recevez pas d'email veuillez vérifier votre dossier \"spams\" ou <a href=\"{{ path('app_forgot_password_request') }}\">essayer encore </a></p>
{% endblock %}
", "reset_password/check_email.html.twig", "C:\\wamp64\\www\\symfony\\3.1 projet-coaching-prod-main\\templates\\reset_password\\check_email.html.twig");
    }
}
