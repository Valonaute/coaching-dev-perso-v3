    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('plainPassword', RepeatedType::class, [
                ...
                'first_options' => [
                    'constraints' => [
                        new Regex('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{12,32}$/', "Votre mot de passe doit contenir 12 à 32 caratères avec des minuscules, majuscules, chiffres et caractères spéciaux")
                    ],
                    'label' => 'Mot de passe',
                ],
                'second_options' => [
