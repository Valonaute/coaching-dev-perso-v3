 ...
 */
class getOrderedItemRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrderedItemRepository' shared autowired service.
     *
     * @return \App\Repository\OrderedItemRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderedItemRepository.php';

        return $container->privates['App\\Repository\\OrderedItemRepository'] = new \App\Repository\OrderedItemRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
